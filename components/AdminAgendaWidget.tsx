...
const AdminAgendaWidget: React.FC<AdminAgendaWidgetProps> = ({ projects }) => {
  const allEvents = projects.flatMap(p => p.agenda || []);
            ...
            return (
              <div key={idx} className="flex gap-4 group cursor-pointer">
                <div className="flex flex-col items-center">
                  ...
                  {idx < allEvents.length - 1 && <div className="w-[1px] flex-1 bg-slate-100 mt-2"></div>}
                </div>
                <div className="pb-6">
